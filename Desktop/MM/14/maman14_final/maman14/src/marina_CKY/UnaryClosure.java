...
/**
 * Calculates and provides assessors for the REFLEXIVE, TRANSITIVE closure of
...
public class UnaryClosure {
	...
	public List<UnaryRule> getClosedUnaryRulesByChild(String child) {
		return Utils.getValueList(closedUnaryRulesByChild, child);
	}

	public List<UnaryRule> getClosedUnaryRulesByParent(String parent) {
		return Utils.getValueList(closedUnaryRulesByParent, parent);
	}
	...
	public UnaryClosure(MarinaGrammar grammar) {
		this(grammar.getUnaryRules());
	}

	private void addUnary(UnaryRule unaryRule, List<String> path) {
		Utils.addToValueList(closedUnaryRulesByChild,
				unaryRule.getChild(), unaryRule);
		Utils.addToValueList(closedUnaryRulesByParent,
